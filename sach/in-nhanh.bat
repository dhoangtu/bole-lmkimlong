...
D:\download\qpdf-10.1.0\bin\qpdf --empty --pages bia-truoc-a5.pdf so-trang-chan-le.pdf bia-sau-trong-a5.pdf bia-sau-a5.pdf -- bole-lmkimlong.pdf

D:\download\qpdf-10.1.0\bin\qpdf --empty --pages so-trang-chan-le.pdf bia-sau-trong-a5.pdf -- in-sach.pdf
